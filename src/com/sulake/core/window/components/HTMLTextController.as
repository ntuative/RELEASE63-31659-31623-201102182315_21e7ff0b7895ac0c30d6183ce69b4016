package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_872:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1655:StyleSheet = null;
      ...
      {
         this.var_703 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1089 == param2)
         {
            return;
         }
         param1.var_1089 = param2;
         param1.var_1655 = null;
         if(param1.var_1089 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1089);
            param1.var_1655 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_755.indexOf(param1) > -1)
         {
            this.var_703 = param1;
         }
      }
      ...
      {
         return this.var_703 == LinkTarget.const_31 ? defaultLinkTarget : this.var_703;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1655;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_703 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_799,this.var_703,PropertyStruct.const_51,true,PropertyDefaults.const_755));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1472);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_799)
            {
               this.var_703 = _loc2_.value as String;
               break;
            }
