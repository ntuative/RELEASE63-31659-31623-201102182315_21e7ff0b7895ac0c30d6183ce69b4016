package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1336:String = "_SELECTOR";
      
      private static const const_1335:String = "_CONTENT";
       
      
      protected var var_1000:ITabSelectorWindow;
      
      protected var var_1984:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1000 = findChildByTag(const_1336) as ITabSelectorWindow;
            if(this.var_1000 != null)
            {
               this.var_1000.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1984 = findChildByTag(const_1335) as IWindowContainer;
         }
      ...
      {
         return !!this.var_790 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1000.numSelectables;
      }
