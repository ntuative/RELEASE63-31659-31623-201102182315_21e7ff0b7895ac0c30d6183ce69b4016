package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1141:IItemListWindow;
      
      private var var_407:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_407)
         {
            this.var_407.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_407.removeEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            this.var_407 = null;
         }
         if(this.var_1141)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1141)
         {
            this.var_1141 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_407)
         {
            this.var_407 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_407)
            {
               this.var_407.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
               this.var_407.addEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            }
         }
         return this.var_407;
      }
