package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_386,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_386 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_386,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_800 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_799 * this.maxScrollH,this.var_532 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1057) ? new PropertyStruct(PropertyDefaults.const_858,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1115) : PropertyDefaults.const_1390);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1045 ? new PropertyStruct(PropertyDefaults.const_743,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1046) : PropertyDefaults.const_1360);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1051 ? new PropertyStruct(PropertyDefaults.const_1160,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1132) : PropertyDefaults.const_1595);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_643) ? new PropertyStruct(PropertyDefaults.const_379,this._field.textColor,PropertyStruct.const_148,true) : PropertyDefaults.const_994);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_623 ? new PropertyStruct(PropertyDefaults.const_248,this.var_40.left,PropertyStruct.const_39,true) : PropertyDefaults.const_478);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_804 ? new PropertyStruct(PropertyDefaults.const_239,this.var_40.top,PropertyStruct.const_39,true) : PropertyDefaults.const_428);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_856 ? new PropertyStruct(PropertyDefaults.const_256,this.var_40.right,PropertyStruct.const_39,true) : PropertyDefaults.const_456);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_657 ? new PropertyStruct(PropertyDefaults.const_251,this.var_40.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_486);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1127 ? new PropertyStruct(PropertyDefaults.const_744,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1451);
