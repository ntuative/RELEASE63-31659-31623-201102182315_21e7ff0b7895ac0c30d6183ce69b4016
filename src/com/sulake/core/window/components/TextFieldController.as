package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_790:Boolean = false;
      ...
      {
         if(param1.type == WindowTouchEvent.const_559)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_790 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_377,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_714,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1641);
         _loc1_.push(this.var_1229 != PropertyDefaults.const_1161 ? new PropertyStruct(PropertyDefaults.const_653,this.var_1229,PropertyStruct.const_36,true) : PropertyDefaults.const_1589);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1031 ? new PropertyStruct(PropertyDefaults.const_763,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1586);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1000 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1452);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_653:
               ...
               case PropertyDefaults.const_763:
                  ...
                  break;
               case PropertyDefaults.const_714:
