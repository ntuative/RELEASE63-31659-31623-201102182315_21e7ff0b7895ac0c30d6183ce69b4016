package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1967:Boolean = false;
      ...
      protected var var_2790:Number = 0.0;
      
      protected var var_2789:Number = 0.0;
      
      protected var var_990:Boolean = true;
      
      protected var var_436:Boolean = false;
      
      protected var var_1223:Boolean = false;
      
      protected var var_1968:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_167 = var_440 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_361,WindowStyle.const_684,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_506,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_291,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_570,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1223;
      }
      ...
      {
         var _loc1_:int = this.var_93 - height;
         return _loc1_ < 0 ? 0 : int(_loc1_);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_649)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_485,this,null));
         }
      }
      ...
      {
         this.var_2790 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2789 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_440,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_530,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_506,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_291,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_570,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         else
         {
            ...
            {
               param1.y = this.var_93 + (this.numListItems > 0 ? this._spacing : 0);
               this.var_93 = param1.rectangle.bottom;
            }
            else
            {
               this.var_93 = Math.max(this.var_93,param1.rectangle.bottom);
            }
            this._container.height = this.var_93;
         }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_198:
               if(this.var_1226)
               {
                  this.var_1225 = this.var_1968 - _loc3_;
                  this.var_1224 = this.var_1966 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1225 != 0 && this.var_104 != 0)
                     {
                        this.scrollH += this.var_1225 / this.var_104;
                     }
                  }
                  else if(this.var_1224 != 0 && this.var_93 != 0)
                  {
                     this.scrollV += this.var_1224 / this.var_93;
                  }
                  this.var_1968 = _loc3_;
                  this.var_1966 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_178:
               if(this.var_1226)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1225,0);
                  }
                  else
                  {
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            ...
            this.scrollV -= param2 / this.var_93;
         }
      }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_990 && !this.var_528 && this._container)
         {
            this.var_528 = true;
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_436)
                     {
                        ...
                        this.var_93 = _loc3_ > this.var_93 ? Number(_loc3_) : Number(this.var_93);
                     }
                  }
                  _loc4_++;
               }
            ...
            else
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.y = this.var_93;
                     this.var_93 += _loc2_.height + this._spacing;
                     if(this.var_436)
                     {
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_633)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_364,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1081);
         }
         if(this.var_990 != PropertyDefaults.const_1065)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_833,this.var_990,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1486);
         }
         if(this.var_436 != PropertyDefaults.const_1095)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_662,this.var_436,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1455);
         }
         if(this.var_1223 != PropertyDefaults.const_1171)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_829,this.var_1223,PropertyStruct.const_36,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_833:
                  this.var_990 = _loc2_.value as Boolean;
                  break;
            }
         }
