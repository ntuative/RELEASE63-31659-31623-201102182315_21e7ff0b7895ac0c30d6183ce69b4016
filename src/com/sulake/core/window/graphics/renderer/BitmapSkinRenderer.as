package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_445[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_315)
                  {
                     var_34.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_487)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_325)
                  {
                     _loc12_ = true;
                     var_34.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_315)
                  {
                     var_34.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_487)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_325)
                  {
                     _loc13_ = true;
                     var_34.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_325 || _loc10_.scaleH == SkinLayoutEntity.const_325)
                  {
                  ...
                  {
                     this.var_884.a = 0 / _loc17_.width;
                     this.var_884.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_884);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_884,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_315)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_315)
               {
