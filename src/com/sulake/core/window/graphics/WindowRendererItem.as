package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_946:uint = 1;
      
      private static const const_947:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1420 = 4294967295;
         this.var_945 = 0;
         this.var_1845 = new ColorTransform();
         this.var_999 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_947) : uint(const_606);
         var _loc6_:Boolean = this.var_181.width > 0 && this.var_181.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_945))
            {
               _loc5_ = const_946;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_946)
               {
                  ...
                  if(this.var_619)
                  {
                     ...
                     _loc7_.draw(param1,this.var_103,this.var_103.rect,this.var_945,false);
                  ...
                  {
                     this.var_999.tx = param2.x;
                     this.var_999.ty = param2.y;
                     this.var_1845.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_103,this.var_999,this.var_1845,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_846.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_175)
            {
               _loc2_ = this.var_846.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_175);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_846.getTheActualState(param1.type,param1.style,param1.state) != this.var_1420;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_556:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1110:
               this.var_945 = this.var_846.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_945 != this.var_1420)
               {
                  this.var_619 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1019:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_619 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1201:
               _loc4_ = true;
         }
         if(_loc4_)
         {
