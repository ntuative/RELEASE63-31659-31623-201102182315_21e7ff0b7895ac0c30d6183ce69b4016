package com.sulake.core.window.services
{
   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IToolTipAgentService
   {
      ...
      protected var var_273:IToolTipWindow;
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            if(param1 is IInteractiveWindow)
            {
               ...
               this.var_1487 = IInteractiveWindow(param1).toolTipDelay;
            }
            else
            {
            ...
            if(this.var_1239 != null && this.var_1239 != "")
            {
               ...
               {
                  this.var_380 = new Timer(this.var_1487,1);
      ...
      override public function operate(param1:int, param2:int) : void
      {
         if(_window && true)
         {
            ...
            if(this.var_273 != null && !this.var_273.disposed)
            {
               this.var_273.x = param1 + this.var_1238.x;
               this.var_273.y = param2 + this.var_1238.y;
            }
         }
      }
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            if(this.var_273 == null || this.var_273.disposed)
            {
               this.var_273 = _window.context.create("undefined::ToolTip",this.var_1239,WindowType.const_402,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            this.var_273.x = _loc2_.x + this.var_1240.x + this.var_1238.x;
            this.var_273.y = _loc2_.y + this.var_1240.y + this.var_1238.y;
         }
      }
