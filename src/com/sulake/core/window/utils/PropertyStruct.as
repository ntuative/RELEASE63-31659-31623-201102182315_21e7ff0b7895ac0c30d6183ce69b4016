package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2763 = param3 == const_238 || param3 == const_147 || param3 == const_245 || param3 == const_236;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_238:
               ...
               _loc1_ = "<var key=\"" + this.var_593 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_236:
               ...
               break;
            case const_148:
               _loc1_ = "<var key=\"" + this.var_593 + "\" value=\"" + "0x" + uint(this.var_173).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_593 + "\" value=\"" + this.var_173 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
