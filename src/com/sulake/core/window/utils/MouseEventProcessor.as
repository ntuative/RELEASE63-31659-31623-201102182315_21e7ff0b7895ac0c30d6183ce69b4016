package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_81:WindowController;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_140 = param1.desktop;
         this.var_81 = param1.var_1220 as WindowController;
         this._lastClickTarget = param1.var_1221 as WindowController;
         this.var_161 = param1.renderer;
         this.var_801 = param1.var_1219;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_651.x || _loc3_.stageY != this.var_651.y)
            {
               ...
               _loc6_ = new Array();
               this.var_140.groupParameterFilteredChildrenUnderPoint(this.var_651,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_81 != this.var_140 && !this.var_81.disposed)
                  {
                     this.var_81.getGlobalPosition(_loc7_);
                     this.var_81.update(this.var_81,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_81,null,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                     this.var_81 = WindowController(this.var_140);
                  }
               }
            }
            while(--_loc4_ > -1)
            {
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  if(_loc3_.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(_loc5_ != this.var_81)
                     {
                        if(!this.var_81.disposed)
                        {
                           this.var_81.getGlobalPosition(_loc7_);
                           this.var_81.update(this.var_81,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_81,_loc5_,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                        }
                        if(!_loc5_.disposed)
                        {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_81 && !this.var_81.disposed)
                     {
                        ...
                        {
                           this.var_801.mouseEventReceived(_loc3_.type,this.var_81);
                        }
                     }
                  }
                  ...
                  if(_loc3_.altKey)
                  {
                     if(this.var_81)
                     {
                        Logger.log("HOVER: " + this.var_81.name);
                     }
                  }
                  if(_loc5_ != this.var_140)
                  {
         ...
         param2.end();
         param1.desktop = this.var_140;
         param1.var_1220 = this.var_81;
         param1.var_1221 = this._lastClickTarget;
         param1.renderer = this.var_161;
         param1.var_1219 = this.var_801;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_505))
         {
