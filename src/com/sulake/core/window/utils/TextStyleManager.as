package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_593:String = "{";
      
      private static const const_592:String = "}";
      
      private static const const_1263:String = "/*";
      
      private static const const_1262:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_186],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_186] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_592);
         if(countSubStrings(param1,const_593) != countSubStrings(param1,const_592))
         {
            throw new Error("Mismatching amount of \"" + const_593 + "\" versus \"" + const_592 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1263) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1262) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_593)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
