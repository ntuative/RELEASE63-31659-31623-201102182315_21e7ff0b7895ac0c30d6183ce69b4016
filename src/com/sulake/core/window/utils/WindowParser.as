package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1838:String = "_INCLUDE";
      
      public static const const_1761:String = "_TEMP";
      
      private static const const_1289:String = "layout";
      
      private static const const_922:String = "window";
      
      private static const const_921:String = "variables";
      
      private static const const_923:String = "filters";
      
      private static const const_597:String = "name";
      
      private static const const_1282:String = "style";
      
      private static const const_598:String = "params";
      
      private static const const_1290:String = "tags";
      ...
      private static const const_1288:String = "visible";
      ...
      private static const const_1019:String = "blend";
      
      private static const const_1278:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1281:String = "treshold";
      
      private static const const_1284:String = "children";
      
      private static const const_1285:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1283:String = "height_min";
      
      private static const const_1286:String = "height_max";
      
      private static const const_599:String = "true";
      
      private static const const_158:String = "0";
      
      private static const const_1287:String = "$";
      
      private static const const_1269:String = ",";
      
      private static const const_47:String = "";
      
      private static const const_1277:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1280:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1234,this.var_1233);
         this.var_997 = new Dictionary();
         this.var_1483 = new Dictionary();
         ParamCodeTable.fillTables(this.var_997,this.var_1483);
         this.var_1981 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1280,const_47);
         return param1.replace(const_1277,const_47);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1483)
            {
               delete this.var_1483[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1289)
         {
            _loc8_ = param1.child(const_921);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_923).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1234[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_597,variables,"")));
         style = uint(this.parseAttribute(xml,const_1282,variables,style));
         params = uint(this.parseAttribute(xml,const_598,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1290,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1270,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1268,variables,const_158));
         visible = this.parseAttribute(xml,const_1288,variables,visible.toString()) == const_599;
         ...
         if(xml.child(const_598).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_597,variables,"") as String;
               if(this.var_997[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_597)) + "\"!");
               }
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_921)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1285,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1283,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1286,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_599;
         blend = Number(this.parseAttribute(xml,const_1019,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1278,variables,window.clipping.toString()) == const_599;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1281,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_923).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1233[param1.type];
