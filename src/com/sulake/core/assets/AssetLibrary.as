package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1023:String = "AssetLibraryReady";
      
      public static const const_637:String = "AssetLibraryLoaded";
      
      public static const const_1572:String = "AssetLibraryUnloaded";
      
      public static const const_1377:String = "AssetLibraryLoadError";
      
      private static var var_307:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_771 = new XML();
         this.var_414 = 0;
         this.var_412 = new Array();
         if(var_307 == null)
         {
            var_307 = new Dictionary(false);
         ...
         this.var_510 = new Dictionary(false);
         this.var_950 = new Dictionary(false);
      ...
      {
         if(this._file == param1.url && this.var_948)
         {
            if(!this.var_951 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_771,this.var_623);
            }
            this.var_951 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1023));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_950)
         {
            delete this.var_950[_loc1_];
         }
         if(this.var_41 != null)
         {
            this.var_41.dispose();
         ...
         this.var_948 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1572));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_950[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_510[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1036,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1173,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1156,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1027,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_510[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_510[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_510[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_307.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_307[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_307[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_307)
            {
               _loc3_ = AssetTypeDeclaration(var_307[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_307)
            {
               _loc4_ = AssetTypeDeclaration(var_307[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_771 = _loc2_.manifest.copy();
         ...
         this.var_948 = true;
         dispatchEvent(new Event(AssetLibrary.const_637));
         dispatchEvent(new Event(AssetLibrary.const_1023));
         if(this.var_951)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1377));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_771.child("library");
         if(_loc2_ == null)
         {
