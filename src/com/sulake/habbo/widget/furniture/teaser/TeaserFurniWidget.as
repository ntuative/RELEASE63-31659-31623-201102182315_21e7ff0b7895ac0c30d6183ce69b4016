package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1694:int = 0;
      
      private const const_1690:int = 1;
      
      private const const_1689:int = 2;
      ...
      private const const_1987:int = 3;
      
      private const const_1985:int = 4;
      
      private const const_1991:int = 5;
      
      private const const_1693:String = "deco_img";
      
      private const const_1695:String = "dialog_bg";
      
      private const const_1992:String = "%campaign%_dialog_bg.png";
      
      private const const_331:String = "%campaign%_gift_package.png";
      
      private const const_1990:String = "%campaign%_gift_content.png";
      
      private const const_1989:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this._imageUrlPath = this.var_151.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1413.length)
         {
            _loc2_ = this.var_1413.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_151 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_546,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_817,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_726,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_546,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_546:
               _loc2_ = this.const_1694;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_726:
               ...
               this._shareId = null;
               this.var_1412 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1411 != _loc2_ || _loc3_ != this.var_179))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_179 = _loc3_;
         this.var_1411 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1411)
            {
               ...
               case this.const_1690:
                  ...
                  else if(this.var_378 == this.const_1986)
                  {
                  ...
                  else if(this.var_378 == this.const_1988)
                  {
                  ...
                  else if(this.var_378 == this.const_1987)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_378 == this.const_1985)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_179,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_378 == this.const_1991)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_1992.replace("%campaign%",this.var_179);
            this.setDecoImage(_loc5_,this.const_1695);
            _loc2_ = _loc2_.replace("%campaign%",this.var_179);
            this.setDecoImage(_loc2_,this.const_1693);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_811);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1412 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1412 == 1 ? "null" : InventoryCategory.const_129);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_813,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1413.push(new ImageDownloader(this,_assets,this.var_179,this._imageUrlPath,param1,param2));
            return;
         }
