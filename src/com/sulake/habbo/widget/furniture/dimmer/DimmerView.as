package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1217,const_1218,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_543 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_382 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1251 = _loc2_.light;
         if(this.var_382 != null)
         {
            this.var_382.setValue(this.var_1251);
         }
         this.var_505 = this.colors.indexOf(_loc2_.color);
         if(this.var_543 != null)
         {
            this.var_543.setSelectedColorIndex(this.var_505);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1252 = XML(_loc1_.content);
         return this.var_1252;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_382 != null)
         {
            this.var_382.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_543 != null)
         {
            this.var_543.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
