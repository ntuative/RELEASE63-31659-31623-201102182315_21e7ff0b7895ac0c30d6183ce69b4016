package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1217;
         this._window.y = const_1218;
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1169 || this.var_343 == -1)
         {
            return;
         }
         ...
         {
            this.var_1169 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_652,this.var_343,name);
