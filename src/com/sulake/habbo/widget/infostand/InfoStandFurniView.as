package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_825 = this.var_197.findChildByTag("catalog");
         if(this.var_825 != null)
         {
            this.var_825.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_52.addListItem(this.var_825);
            }
            this.var_825.visible = param1;
         }
         else
         {
            this.var_52.removeListItem(this.var_825);
         }
      }
   }
}
