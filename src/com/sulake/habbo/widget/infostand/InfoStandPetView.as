package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_197:IBorderWindow;
      
      private var var_65:IItemListWindow;
      
      private var var_52:IItemListWindow;
      
      private var var_198:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_476:int;
      
      private const const_1975:int = 152;
      
      private const const_1971:int = 16;
      
      private const const_1304:int = 4;
      
      private const const_1967:uint = 14342874;
      
      private const const_1974:uint = 3815994;
      
      private const const_1968:uint = 2085362;
      
      private const const_1976:uint = 39616;
      
      private const const_1977:uint = 10513106;
      
      private const const_1970:uint = 8734654;
      
      private const const_1979:uint = 9094430;
      
      private const const_1969:uint = 6200576;
      
      private const const_1973:String = "happiness";
      
      private const const_1978:String = "experience";
      
      private const const_1972:String = "energy";
      ...
      {
         if(this.var_52 == null || this.var_197 == null || this.var_65 == null)
         {
            return;
         }
         ...
         this.var_197.height = this.var_52.height + 20;
         this._window.width = Math.max(this.var_197.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_197.width < this.var_65.width)
         {
            this.var_197.x = this._window.width - this.var_197.width;
            this.var_65.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1973,param1.nutrition,param1.nutritionMax,this.const_1976,this.const_1968);
         this.updateStateElement(this.const_1978,param1.experience,param1.experienceMax,this.const_1970,this.const_1977);
         this.updateStateElement(this.const_1972,param1.energy,param1.energyMax,this.const_1969,this.const_1979);
         ...
         this.updateWindow();
         this.var_476 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_198 && this.var_198.isVisible() && param1.isOwnPet)
         {
            this.var_198.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_198.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1975,this.const_1971,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1967);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1974);
      ...
      private function openTrainView() : void
      {
         if(this.var_198 == null)
         {
            this.var_198 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_476) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_198.showWindow(true);
            this.var_198.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_197 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_197 != null)
         {
            this.var_52 = this.var_197.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_197.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_197.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_197.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_197.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_198 && this.var_198.getPetId() == this.var_476)
               {
                  this.var_198.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_538,this._widget.petData.ownerId);
