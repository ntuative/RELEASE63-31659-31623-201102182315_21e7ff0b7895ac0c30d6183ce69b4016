package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1221:int = 9;
      
      private static const const_900:int = 10;
      
      private static const const_581:int = 25;
      
      private static const const_1212:int = 25;
      
      private static const const_899:int = 4000;
      
      private static const const_1220:int = 6000;
      
      private static const const_1222:int = 3;
      
      private static const const_1219:int = 1;
      
      private static const const_582:int = 8;
      
      private static const const_410:int = 0;
      
      private static const const_901:int = (const_582 + const_410) * const_109 + const_109;
      ...
      private var var_2048:int = 150;
      
      private var var_205:int = 171.0;
      
      private var var_811:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_38 = param1.createWindow("chat_container","",HabboWindowType.const_62,HabboWindowStyle.const_31,HabboWindowParam.const_41,new Rectangle(0,0,200,this.var_205 + RoomChatHistoryPulldown.const_83),null,0) as IWindowContainer;
         this.var_38.background = true;
         this.var_38.color = 33554431;
         this.var_38.tags.push("room_widget_chat");
         this.var_321 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1071,HabboWindowStyle.const_41,0 | 0,new Rectangle(0,0,200,this.var_205),null,0) as IItemListWindow;
         this.var_38.addChild(this.var_321);
         this.var_105 = param1.createWindow("chat_active_content","",HabboWindowType.const_62,HabboWindowStyle.const_41,HabboWindowParam.const_60,new Rectangle(0,0,200,this.var_205),null,0) as IWindowContainer;
         this.var_105.clipping = false;
         this.var_321.addListItem(this.var_105);
         this.var_28 = new RoomChatHistoryViewer(this,param1,this.var_38,param2);
         this.var_2049 = param4.getKey("site.url");
         this.var_2048 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1008 && this.var_1008 > 0)
         {
            this.var_1008 = -1;
            this.animationStart();
         }
         if(this.var_814)
         {
            _loc2_ = param1 / const_1212 * const_1222;
            if(_loc2_ + this.var_813 > this.var_811)
            {
               _loc2_ = this.var_811 - this.var_813;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_813 >= this.var_811)
            {
               this.var_811 = const_109;
               this.var_813 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1008 = getTimer() + const_899;
            }
         }
         if(this.var_28 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_687,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_687,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2049);
         _loc2_.define(param1);
         if(this.var_812 != 1)
         {
            _loc2_.senderX /= this.var_812;
         }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1512 == 0)
            {
               this.var_1512 = param1.scale;
            }
            else
            {
               this.var_812 = param1.scale / this.var_1512;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_663.x += param1.positionDelta.x / this.var_812;
            this.var_663.y += param1.positionDelta.y / this.var_812;
         }
         if(param1.rect != null)
         {
            if(this.var_28 == null)
            ...
            this.var_321.width = this.var_38.width - this.var_28.scrollbarWidth;
            this.var_321.height = this.var_205;
            this.var_321.x = this.var_38.x;
            this.var_321.y = this.var_38.y;
            this.var_105.width = this.var_38.width - this.var_28.scrollbarWidth;
            this.var_105.height = this.var_205;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_67.length > const_1219 || this.historyViewerActive() && this.var_67.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_811 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_67[0]);
            }
            else
            {
               this.var_811 = const_109;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_662,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_662;
               if(_loc1_.aboveLevels > const_582 + const_410 + 2)
               {
                  _loc1_.aboveLevels = const_582 + const_410 + 2;
               }
               this.var_662 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_410 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1220)
               {
      ...
      private function moveItemsUp(param1:int) : void
      {
         ...
         var _loc2_:* = null;
         var _loc4_:int = -1;
         var _loc5_:int = this.var_232.length - 1;
         while(_loc5_ >= 0)
         {
            _loc2_ = this.var_232[_loc5_];
            if(_loc2_ != null)
            {
               if(_loc4_ == -1)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_663.x) * this.var_812;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_38.width / 2 - const_900;
         var _loc6_:Number = this.var_38.width / 2 + const_900 - this.var_28.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_662);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_109 - const_411;
            }
            else
            {
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2048)
         {
            _loc2_ = this._itemList.shift();
            _loc3_ = this.var_232.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
      ...
      {
         return "chat_" + this.var_2046.toString() + "_item_" + (this.var_2047++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_387,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_772,param1,param2,param4,param5);
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_205 = const_901 + const_411;
         this.var_38.height = this.var_205 + this.var_28.pulldownBarHeight;
         this.var_321.width = this.var_38.width - this.var_28.scrollbarWidth;
         this.var_321.height = this.var_205;
         this.var_105.width = this.var_38.width - this.var_28.scrollbarWidth;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1066)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(this.var_1513 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1513 = false;
         }
