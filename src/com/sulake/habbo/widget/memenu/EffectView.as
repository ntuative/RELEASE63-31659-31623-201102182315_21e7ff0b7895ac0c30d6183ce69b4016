package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_894 != null)
         {
            if(this.var_174.isActive)
            {
               ...
               this.var_894.width = _loc2_ * this.var_300;
            }
            else
            {
               this.var_894.width = 0;
               this.var_203.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_893.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_893.text;
            if(this.var_174.isActive)
            {
               _loc2_ = this.var_174.secondsLeft;
               ...
               this.var_893.text = _loc1_;
            }
            else
            {
               this.var_893.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_892 = this._window.findChildByName("effect_hilite");
            this.var_892.visible = false;
         }
         this.var_893 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_894 = this._window.findChildByName("loader_bar");
         if(this.var_894 != null)
         {
            this.var_300 = this.var_894.width;
            this.var_203.start();
            this.onUpdate();
         }
