package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_468 = param1.volume;
         if(this.var_901 != null)
         {
            this.var_901.setValue(this.var_468);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1728 = (_loc5_.content as BitmapData).clone();
         }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_468 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1726);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1727);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_468 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1728);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1725);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_617);
         }
         else
         {
