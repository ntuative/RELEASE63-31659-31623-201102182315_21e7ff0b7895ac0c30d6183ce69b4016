package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_490:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_490.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_490 = null;
         }
         if(this.var_44 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_490 == null)
         {
            this.var_490 = new Sprite();
            this.var_490.addChild(new Bitmap(this.var_44));
            this.var_490.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_490.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_44;
            }
         }
         _loc2_.setDisplayObject(this.var_490);
