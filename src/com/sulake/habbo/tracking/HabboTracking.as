package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_951:uint = 11;
      ...
      private var var_1177:IHabboWindowManager;
      
      private var var_172:IHabboToolbar;
      
      private var var_170:IHabboHelp;
      ...
      private var var_262:PerformanceTracker = null;
      
      private var var_628:FramerateTracker = null;
      
      private var var_261:LatencyTracker = null;
      
      private var var_626:LagWarningLogger = null;
      
      private var var_627:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_262 = new PerformanceTracker();
         this.var_628 = new FramerateTracker();
         this.var_261 = new LatencyTracker();
         this.var_626 = new LagWarningLogger();
         this.var_627 = new ToolbarClickTracker(this);
         this.var_1440 = new Array(const_951);
         var _loc4_:int = 0;
         while(_loc4_ < const_951)
         {
            this.var_1440[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1387,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1372,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1384,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_629,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1194,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1177)
            {
               this.var_1177.release(new IIDHabboWindowManager());
               this.var_1177 = null;
            }
            if(this.var_313)
            {
            ...
            if(this.var_201)
            {
               if(!this.var_201.disposed)
               {
                  ...
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_170)
            {
               ...
               {
                  this.var_170.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_170.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_170.release(new IIDHabboHelp());
               this.var_170 = null;
            }
            if(this.var_172)
            {
               ...
               {
                  this.var_172.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_184)
         {
            if(this.var_261 != null)
            {
               this.var_261.configuration = this.var_184;
            }
            if(this.var_262 != null)
            {
               this.var_262.configuration = this.var_184;
            }
            ...
            if(this.var_184)
            {
               ...
               {
                  this.var_626.configure(this.var_184);
               }
               if(this.var_628 != null)
               {
                  this.var_628.configure(this.var_184);
               }
               if(this.var_627 != null)
               {
                  this.var_627.configure(this.var_184);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_796,this.onConnectionEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_261 != null)
            {
               this.var_261.communication = this._communication;
               this.var_261.connection = param1;
            }
            if(this.var_626 != null)
            {
               this.var_626.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1548);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1591);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1470);
               break;
            case HabboCommunicationEvent.const_796:
               this.trackLoginStep(HabboLoginTrackingStep.const_1478,String(this._communication.port));
               break;
      ...
      {
         this.var_1177 = IHabboWindowManager(param2);
         if(this.var_1177)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_184)
            {
               if(this.var_184.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1440)
                  {
                  ...
                  if(this.var_262 != null)
                  {
                     _loc4_["null"] = this.var_262.flashVersion;
                     _loc4_["null"] = this.var_262.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1134);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1134,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_170 = param2 as IHabboHelp;
         this.var_170.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_170.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2653)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1540);
            this.var_2653 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1194,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_629,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_277,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_313 = param2 as IAdManager;
         this.var_313.events.addEventListener(AdEvent.const_425,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_172 = param2 as IHabboToolbar;
         this.var_172.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_627)
         {
            this.var_627.track(param1.iconName);
         }
      }
      ...
      {
         this.var_626.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1865;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1865);
         }
         if(this.var_512 > -1 && _loc2_ - this.var_512 > 15000)
         {
            ++this.var_1864;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1864);
         }
         this.var_512 = _loc2_;
         if(this.var_262 != null)
         {
            this.var_262.update(param1,this.var_512);
         }
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_512);
         }
         if(this.var_628 != null)
         {
            this.var_628.trackUpdate(param1,this,this.var_512);
         }
         if(this.var_626 != null)
         {
            this.var_626.update(this.var_512);
         }
      }
   }
}
