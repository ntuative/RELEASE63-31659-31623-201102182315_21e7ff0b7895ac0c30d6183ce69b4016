   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_822,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_785,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_172 != null)
            {
               this.var_172.events.removeEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_495,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_822,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_785,this.onHabboClubSubscriptionChanged);
         }
         this.var_172 = this._container.toolbar;
         if(this.var_172 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_495,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1350)
            {
               ...
               this.var_1350 = _loc2_;
               this.var_1707 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1707;
            }
         }
         if(this.var_172 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1140,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_172.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_791);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_663);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_805);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_851);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_889);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_351);
         _loc1_.push(RoomWidgetStopEffectMessage.const_746);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1465);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1076);
         _loc1_.push(RoomWidgetToolbarMessage.const_798);
         _loc1_.push(RoomWidgetToolbarMessage.const_896);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_399);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1481);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1022);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_707);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_742);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_790);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1508);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_617);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_720);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_838);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_368);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_742:
            ...
            case RoomWidgetDanceMessage.const_614:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_791:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_663:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_805:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_351:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1034)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_889:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1012:
                        this._catalog.openCatalogPage(CatalogPageName.const_1627,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1003:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_294);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1513:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1397:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_851:
            case RoomWidgetStopEffectMessage.const_746:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1056:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1559:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1076:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_707:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_798:
               ...
               if(this.var_172)
               {
                  this.var_172.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_896:
               ...
               {
                  this.var_172.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_544,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_399:
            ...
            case RoomWidgetGetSettingsMessage.const_790:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_617:
            ...
            case RoomWidgetStoreSettingsMessage.const_720:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_373,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_838:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_431));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_368:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_709));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_854));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_495:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_435));
         }
      }
