package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_673);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_814);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_660);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_673:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_814:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_660:
