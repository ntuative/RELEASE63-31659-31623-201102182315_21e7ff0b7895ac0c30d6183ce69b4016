package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_816,RoomWidgetViralFurniMessage.const_811,RoomWidgetViralFurniMessage.const_163];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_816:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_546);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_811:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_509,RoomSessionViralFurniStatusEvent.const_473];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionViralFurniStatusEvent.const_473:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_726);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
