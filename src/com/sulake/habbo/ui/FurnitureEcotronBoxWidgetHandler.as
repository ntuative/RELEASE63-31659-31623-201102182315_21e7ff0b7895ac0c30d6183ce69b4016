package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_752,RoomWidgetEcotronBoxOpenMessage.const_848,RoomWidgetEcotronBoxOpenedMessage.const_1501];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_752:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_848:
