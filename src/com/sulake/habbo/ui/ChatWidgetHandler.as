package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1759:Map = null;
      
      private var var_1137:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1136:Number = 0.0;
      ...
      {
         return [RoomWidgetChatMessage.const_703,RoomWidgetChatSelectAvatarMessage.const_772];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_703:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1101))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1101))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_772:
      ...
      {
         return [RoomSessionChatEvent.const_197];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_197:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_185)
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_185:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1136 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1136);
            }
            if(this.var_729 == null)
            {
               ...
               this.var_493.y = 0;
               this.var_493.z = 0;
               this.var_729 = _loc4_.getScreenPoint(this.var_493);
               this.var_1136 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_493.x = 0;
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_405)
         {
            _loc2_ = this.var_405.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1137.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_85,this);
            if(_loc5_ != null)
            {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1759.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1759.remove(param1);
         if(_loc3_ != null)
         {
