package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_771);
         _loc1_.push(RoomWidgetFurniActionMessage.const_845);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_832);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_821);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_860);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1504);
         _loc1_.push(RoomWidgetPetCommandMessage.const_510);
         _loc1_.push(RoomWidgetPetCommandMessage.const_702);
         _loc1_.push(RoomWidgetUserActionMessage.const_548);
         _loc1_.push(RoomWidgetUserActionMessage.const_388);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_732);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_388 || param1.type == RoomWidgetUserActionMessage.const_548 || param1.type == RoomWidgetUserActionMessage.const_452)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_766:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1155,_loc3_.name);
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_771:
            ...
            case RoomWidgetUserActionMessage.const_388:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_832:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_821:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_860:
            ...
            case RoomWidgetUserActionMessage.const_891:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_702:
            ...
            case RoomWidgetPetCommandMessage.const_510:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_732:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_405);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1139);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1135);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_185)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_182)
               {
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_446);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_116)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_150)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_803);
                  ...
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1172;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1424);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_803);
