package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1980:String = "hd-99999-99999";
      ...
      private var var_735:PaletteManager;
      ...
      private var var_1793:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_625 = RenderMode.const_1597;
         ...
         this.var_102.add(AvatarType.const_113,_loc4_);
         ...
         this.var_102.add(AvatarType.const_63,_loc4_);
         ...
         this.var_735 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_220)
         {
            this.var_220.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_302.init();
         this.var_735.init();
         _loc2_ = this.var_102.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_102.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_102.getValue(AvatarType.const_113) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_220 == null)
               {
                  ...
                  this.var_220 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_220.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_948)
         {
            if(this.var_2548 && this.var_2546 && this.var_2547)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_220.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_220.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_102.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_220.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1793)
         {
            this.var_1793 = new AvatarFigureContainer(this.const_1980);
         }
         this.var_220.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1793,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_303 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_303.getKeys())
         {
            _loc4_ = this.var_303.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1634)
         {
            _loc6_ = !this.var_302.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_302.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_102.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_303.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_102.getValue(AvatarType.const_63);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_303.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_303.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_102.getValue(AvatarType.const_113) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_63:
               _loc3_ = this.var_102.getValue(AvatarType.const_63) as AvatarStructure;
               break;
            default:
