package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1215:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1213:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1002:AvatarEditorHandler;
      ...
      private var var_808:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_187)
         {
            ...
            _loc2_.loadAvatarData(const_1215,FigureData.const_80);
            _loc3_.loadAvatarData(const_1213,FigureData.FEMALE);
            this.var_96 = new Map();
            this.var_446 = new Map();
            this.var_96.add(AvatarEditorFigureCategory.const_827,new BodyModel(this));
            this.var_96.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_96.add(AvatarEditorFigureCategory.const_223,new TorsoModel(this));
            this.var_96.add(AvatarEditorFigureCategory.const_705,new LegsModel(this));
            ...
            this.var_446.add(AvatarEditorSideCategory.const_102,new WardrobeModel(this));
            this.var_446.add(AvatarEditorSideCategory.const_481,new ClubPromoModel(this));
            this.var_187 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_808.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_808.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_827);
         }
      ...
      {
         this.var_808 = this.var_447.getFigureData(AvatarType.const_113);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1002 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_541[this.var_860];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1249 != null)
         {
            ...
            this.var_1249.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1495;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1003 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1214)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1477.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1528)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1003 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1003 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_446.getValue(AvatarEditorSideCategory.const_102);
      }
