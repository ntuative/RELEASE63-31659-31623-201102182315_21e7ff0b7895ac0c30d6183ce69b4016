package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1477:IWindowContainer;
      
      public static var var_1952:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1025 = [];
         this.var_1268 = [AvatarEditorFigureCategory.const_827,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_223,AvatarEditorFigureCategory.const_705,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_102];
         super();
         ...
         if(var_1477 == null)
         {
            ...
            var_1477 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_385 = new Timer(1000);
         this.var_385.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1268;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_385.stop();
            this.var_385.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_385 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1268);
         }
         if(param1.length != this.var_1025.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2118 = this.canChangeOutfit();
            this.var_385.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1025.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1268;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1538 == AvatarEditorSideCategory.const_102 || this.var_2119))
         {
      ...
      {
         if(this.var_1538 == AvatarEditorSideCategory.const_102)
         {
            this.var_2119 = false;
            this.setSideContent(AvatarEditorSideCategory.const_756);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_756:
               break;
            case AvatarEditorSideCategory.const_481:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_481);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_358 = param1;
         this.var_458.setSelected(this.var_458.method_1(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_457)
         {
            ...
            this.var_457 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_457.procedure = this.stripClubDialogEventProc;
            this.var_457.center();
         }
         else
         {
