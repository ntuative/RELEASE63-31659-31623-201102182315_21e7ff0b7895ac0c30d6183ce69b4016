package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2051 = parseInt(_loc2_,16);
         this.var_2053 = parseInt(_loc3_,16);
         ...
         this.var_1845 = new ColorTransform(this.var_1548,this.var_1549,this.var_1547,this._alphaMultiplier);
         this.var_1010 = this.generatePaletteMapForGrayscale(this.var_2053,this.var_2051);
      }
      ...
      {
         return this.var_1010.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1010.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1010.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1010.getValue("alphas") as Array;
      }
