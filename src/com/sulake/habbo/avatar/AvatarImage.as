package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_686:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_260:AvatarImageCache;
      
      protected var var_581:AvatarFigureContainer;
      ...
      private var var_2114:String = null;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_234.length == 1 && this.var_87 == this.var_1969)
         {
            return this.var_87 + this.var_456 + this.var_555 % 4;
         }
      ...
      {
         if(param3 != this.var_2116 || param2 != this.var_2115 || param1 != this.var_2114)
         {
            this.var_2116 = param3;
            this.var_2115 = param2;
            this.var_2114 = param1;
            this.var_1537 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1227 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1227)
            {
               this.var_44.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_269.definition.geometryType,this.var_87);
         this.var_44.lock();
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_314.push(new ActiveActionData(param1,param2,this.var_555));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_918);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_456 = "";
         this.var_234 = this._structure.sortActions(this.var_314);
         if(this.var_234 == null)
         {
         ...
         {
            this.var_686 = this._structure.getCanvasOffsets(this.var_234,this._scale,this.var_87);
            for each(_loc4_ in this.var_234)
            {
               this.var_456 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_296)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1266 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1266 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_234)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_814 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_283 || _loc1_.actionType == AvatarAction.const_253 || _loc1_.actionType == AvatarAction.const_340)
               {
                  this.var_814 = true;
               }
            }
