   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_196,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_230,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_228,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_252,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_227,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_139 == "")
         {
            var_66.switchCategory(FigureData.const_196);
         }
      }
