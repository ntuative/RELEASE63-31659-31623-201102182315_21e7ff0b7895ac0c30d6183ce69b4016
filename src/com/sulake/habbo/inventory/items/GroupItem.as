package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_806:int = 0;
      
      protected var var_654:BitmapData;
      
      protected var var_2572:int;
      
      protected var var_1482:Boolean;
      
      protected var var_1979:Boolean;
      
      protected var var_2740:BitmapData;
      ...
      public function initImage() : void
      {
         ...
         if(this._mainCategory == FurniModel.const_46)
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1334));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_895)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
