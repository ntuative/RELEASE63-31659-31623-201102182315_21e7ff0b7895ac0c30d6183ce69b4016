package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1037:IRoomSession;
      ...
      {
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_284));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_884));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_294));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_384));
      }
      ...
      {
         return PetsModel(this.var_50.getValue(InventoryCategory.const_129));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_50.getValue(InventoryCategory.const_363) as MarketplaceModel;
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_404 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_172)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_172);
         this.var_50 = new Map();
         ...
         this.var_50.add(InventoryCategory.const_363,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_294,_loc3_);
         ...
         this.var_50.add(InventoryCategory.const_884,_loc4_);
         ...
         this.var_50.add(InventoryCategory.const_384,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_284,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_129,_loc8_);
         this.var_187 = true;
         if(this.var_2404)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_890.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_890.indexOf(param1);
            if(_loc3_ >= 0)
            {
