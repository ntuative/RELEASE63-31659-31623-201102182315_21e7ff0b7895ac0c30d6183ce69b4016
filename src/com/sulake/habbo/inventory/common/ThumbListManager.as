package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1282:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_88 = this.var_560.height;
         this.var_1038 = param5;
         this.var_832 = param6;
         this.var_207 = Math.floor(this.var_1038 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1038,this.var_832);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_207 * this._thumbWidth,this.var_1038),Math.max(this.var_559 * this.var_88,this.var_832),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_207 && this.var_26.height < _loc3_.y * this.var_88)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_207 - 1),this.var_88);
         ...
         _loc4_ = new Rectangle(0,this.var_88,this._thumbWidth * (this.var_207 - 1),this.var_26.height - this.var_88);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1282.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_832)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_832);
