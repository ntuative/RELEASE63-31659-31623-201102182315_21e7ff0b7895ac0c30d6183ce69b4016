package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_965:uint = 4284532064;
      
      private static const const_966:uint = 2577770;
      ...
      private var var_435:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_435 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1930 = this.createMinimizedWindow();
         }
         if(!this.var_2726)
         {
            return this.var_69;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_69)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_965) : uint(const_966);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_965) : uint(const_966);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_980)
            {
            ...
            this.var_435.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_462);
            this.var_435.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_435.hideDelayed();
         }
      }
