package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_46:String = "floor";
      
      public static const const_48:String = "wall";
      
      public static const const_378:String = "pets";
      
      private static const const_1267:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_589 = new Timer(const_1267,1);
         this.var_589.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2352 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_589.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_589.stop();
               this.var_589 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_392)
         {
         ...
         if(this.var_880 == null)
         {
            this.var_880 = this._windowManager.buildFromXML(this.var_2352) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_880.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_363);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_480.add(const_46,new Array());
         this.var_480.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_362 || _loc3_.category == FurniCategory.const_392 || _loc3_.category == FurniCategory.const_376)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1333 && param1.type == RoomEngineObjectEvent.const_222)
         {
            this.var_1333 = false;
         }
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_895)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
