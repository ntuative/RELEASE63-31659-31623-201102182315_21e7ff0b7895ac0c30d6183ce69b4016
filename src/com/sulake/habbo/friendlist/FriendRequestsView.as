package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1700:String = "no_reqs_info";
      ...
      private var var_1885:IContainerButtonWindow;
      
      private var var_1886:IContainerButtonWindow;
      ...
      {
         this.var_1885 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1886 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1886.procedure = this.onDismissAllButtonClick;
         this.var_1885.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_374)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1130)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_374;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_336 && _loc4_.state != FriendRequest.const_374)
            {
               _loc4_.state = FriendRequest.const_374;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1885,_loc1_);
         this.setEnabled(this.var_1886,_loc1_);
      }
