package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_776:ISessionDataManager;
      
      private var var_2671:FriendListLookAndFeel;
      
      private var var_424:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1875:OpenedToWebPopup;
      ...
      private var var_1874:AvatarSearchResults;
      ...
      {
         this.var_2671 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_96 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1874 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_631.stop();
            this.var_631.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_631 = null;
         }
         ...
         if(this.var_840)
         {
            this.var_840.release(new IIDHabboNotifications());
            this.var_840 = null;
         }
         if(this.var_172)
         {
         ...
         if(this.var_776)
         {
            this.var_776.release(new IIDSessionDataManager());
            this.var_776 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1875 = new OpenedToWebPopup(this);
         }
         this.var_1875.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_364.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_172.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_288,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1109.createAvatarImage(param1,AvatarScaleType.const_85,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_172 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_840 = param2 as IHabboNotifications;
      ...
      {
         this.var_776 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_364 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_96.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_96.addCategory(new FriendCategory(FriendCategory.const_1035,this.getText("friendlist.friends")));
         this.var_96.addCategory(new FriendCategory(FriendCategory.const_395,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_96.addFriend(new Friend(_loc4_));
         }
         this.var_424 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_631)
         {
            this.var_631 = new Timer(120000);
            this.var_631.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_631.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_172.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_96.findCategory(FriendCategory.const_395);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_424.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_364.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_364.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_424.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_364.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_424.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1874.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_424.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_776 || !this.var_364)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_776.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_364.vipLimit;
         }
         else if(this.var_776.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_364.clubLimit;
         }
         if(_loc2_ > this.var_364.limit)
         {
            this.var_364.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_159) as IBitmapWrapperWindow;
