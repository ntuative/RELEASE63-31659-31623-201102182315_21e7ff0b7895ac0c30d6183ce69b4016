package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_1035:int = 0;
      ...
      {
         return Math.ceil(this.var_225.length / const_389);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_964 * const_389;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_964 + 1) * const_389,this.var_225.length);
      }
