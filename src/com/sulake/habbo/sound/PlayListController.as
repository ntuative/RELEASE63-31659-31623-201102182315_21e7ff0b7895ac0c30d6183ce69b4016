package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1956:String = "type_sound_machine";
      
      private const const_1674:String = "type_jukebox";
      
      private var var_592:HabboSoundManagerFlash10;
      
      private var _connection:IConnection;
      
      private var _events:IEventDispatcher;
      
      private var var_91:IEventDispatcher;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_695,this.onSongFinishedPlayingEvent);
         this.var_91.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_807,this.onSoundMachinePlayEvent);
         this.var_91.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_861,this.onSoundMachineStopEvent);
         this.var_91.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_678,this.onJukeboxInitEvent);
         this.var_91.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_460,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_695,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_91)
            {
               this.var_91.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_807,this.onSoundMachinePlayEvent);
               this.var_91.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_861,this.onSoundMachineStopEvent);
               this.var_91.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_678,this.onJukeboxInitEvent);
               this.var_91.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_460,this.onDisposeEvent);
               this.var_91 = null;
            }
            if(this.var_399)
            {
      ...
      {
         this.startPlaying(this.const_1956);
      }
      ...
      {
         this.startPlaying(this.const_1674);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_399[this.var_284] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_399.getValue(this.var_284) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_284 = param1;
         var _loc2_:IHabboSound = this.var_399.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_592.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_592.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_284)
         {
            _loc6_ = this.var_399[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1660 == this.const_1674)
         {
            this.var_76.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_399[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_592.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_399.add(_loc3_.id,_loc7_);
            }
