package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1894 = this._navigator.getButtonImage(this.var_1895);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1896 == null)
         {
            ...
            this.var_1896 = new Rectangle(this.var_1456,this.var_1456,_loc1_.width - 2 * this.var_1456,_loc1_.height - 2 * this.var_1456);
         }
         this.var_637.bitmap.fillRect(this.var_637.bitmap.rect,4281545523);
         this.var_637.bitmap.fillRect(this.var_1896,4284900966);
         this.copyTo(this.var_637.bitmap);
         if(this.var_200)
         {
            this.var_637.bitmap.copyPixels(this.var_1897,this.var_1897.rect,new Point(0,0),null,null,true);
         }
