package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1061:RoomCreateViewCtrl;
      ...
      private var var_2249:RoomThumbnailRenderer;
      
      private var var_987:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_280 = new MainViewCtrl(this);
         this.var_577 = new RoomInfoViewCtrl(this);
         this.var_1061 = new RoomCreateViewCtrl(this);
         this.var_2249 = new RoomThumbnailRenderer(this);
         this.var_987 = new GuestRoomPasswordInput(this);
         this.var_320 = new GuestRoomDoorbell(this);
         this.var_424 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_288,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_172.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_172.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_172.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_280.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_280.startSearch(Tabs.const_217,Tabs.const_345,param1);
         this.var_280.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_280.startSearch(Tabs.const_320,Tabs.const_269);
         this.var_424.getTab(Tabs.const_320).tabPageDecorator.tabSelected();
      }
