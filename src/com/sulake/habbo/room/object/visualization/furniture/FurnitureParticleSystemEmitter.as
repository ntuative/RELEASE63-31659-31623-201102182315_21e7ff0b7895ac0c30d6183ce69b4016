package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1460:String = "plane";
      
      public static const const_1413:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_985 = 0;
         this.var_971 = false;
         this.init(0,0,0,this._direction,this.var_2718,this.var_984,this.var_2716,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1205.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_971 = true;
         if(this.var_985 < this.var_1472)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2715)
         {
            switch(this.var_2714)
            {
               case const_1364:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1205.length);
         return this.var_1205[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_985 < this.var_1472)
         {
            if(this.age % this.var_2713 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_985 < this.var_1472)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_267) * this.x - (1 - this.var_267) * this.lastX;
            this.y = (2 - this.var_267) * this.y - (1 - this.var_267) * this.lastY + this.var_1922 * this.var_984 * this.var_984;
            this.z = (2 - this.var_267) * this.z - (1 - this.var_267) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_373)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_267) * _loc2_.x - (1 - this.var_267) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_267) * _loc2_.y - (1 - this.var_267) * _loc2_.lastY + this.var_1922 * this.var_984 * this.var_984;
            _loc2_.z = (2 - this.var_267) * _loc2_.z - (1 - this.var_267) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
