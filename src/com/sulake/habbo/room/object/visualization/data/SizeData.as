package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_371:int = 1000;
      ...
      private var var_1112:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            {
               _loc2_ = this.var_245.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_245.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_245.add(String(_loc7_),_loc3_);
            this.var_1706 = -1;
            this.var_1112 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1189);
                  break;
               case "SUBTRACT":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1349 / 2) % 360 / this.var_1349;
         if(this.var_245.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_245.getKey(_loc5_)) * this.var_1349;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_245.getKey(_loc4_));
         }
         return const_1436;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_245.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_722;
         }
