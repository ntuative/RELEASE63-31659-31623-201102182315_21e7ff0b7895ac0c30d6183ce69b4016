package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1512:int = const_358;
      ...
      public static const const_303:int = const_112;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2285 = param6;
         this.var_2286 = param7;
         this.var_751 = new Vector3d();
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_751 != null)
         {
            this.var_751.assign(new Vector3d());
         }
         this.var_629 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_363.length)
         {
            _loc2_ = this.var_363[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = this.var_363[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_363[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this.var_751,param4))
               {
                  if(param1 != null)
                  {
         ...
         {
            _loc11_ = this.var_363[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1871 == const_112)
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_629);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_629,this.var_31.width,this.var_629);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         {
            _loc4_ = this.var_363[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
