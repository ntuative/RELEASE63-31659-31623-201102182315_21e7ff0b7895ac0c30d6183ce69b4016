package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1492:int = 16777215;
      
      public static const const_1462:int = 13421772;
      ...
      private var var_785:Rectangle = null;
      ...
      private var var_2704:int = 255;
      
      private var var_2702:int = 255;
      
      private var var_2703:int = 255;
      ...
      private const const_1995:int = 250;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_785 = super.boundingRectangle;
         }
         return new Rectangle(this.var_785.x,this.var_785.y,this.var_785.width,this.var_785.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1207);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_986);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1373)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_111,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1995 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_640[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_370[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_94)
               {
                  if(this.var_1910)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2703 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2702 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2704 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1552)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1338 || _loc3_.y != this.var_2380 || _loc3_.z != this.var_2381 || param1.scale != this.var_2379))
            {
               this.var_1338 = _loc3_.x;
               this.var_2380 = _loc3_.y;
               this.var_2381 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            ...
            if(_loc4_ != this.var_1199)
            {
               ...
               this.var_2703 = this.var_1199 & 255;
               this.var_2702 = this.var_1199 >> 8 & 255;
               this.var_2704 = this.var_1199 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_968));
            if(_loc5_ != this.var_1910)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_674);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_774);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_831));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_760));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1802;
      }
         ...
         while(_loc8_ < this.var_520.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_124.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_94)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_94 && _loc12_ == RoomPlaneBitmapMaskData.const_240)
                              {
