package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1586:int = 255;
      
      private var var_1050:uint = 16777215;
      
      private var var_1587:int = 255;
      
      private var var_1049:int = 0;
      
      private var var_1588:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1207,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_632,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_831,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1049)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1585;
            if(_loc2_ - this.var_1049 >= this.var_1588)
            {
               _loc3_ = this.var_1050;
               _loc4_ = this.var_1587;
               this.var_1049 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1050 >> 16 & 255;
               _loc11_ = this.var_1050 >> 8 & 255;
               _loc12_ = this.var_1050 & 255;
               _loc13_ = (_loc2_ - this.var_1049) / this.var_1588;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1586 + (this.var_1587 - this.var_1586) * _loc13_;
               this._color = _loc3_;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_890:
               param2.setString(RoomObjectVariableEnum.const_761,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_681:
               param2.setString(RoomObjectVariableEnum.const_774,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_477:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_706:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1184,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1151:
               param2.setNumber(RoomObjectVariableEnum.const_831,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_970:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_968,int(param1.bgOnly));
         this.var_1287 = this._color;
         this.var_1586 = this.var_1585;
         this.var_1050 = _loc3_;
         this.var_1587 = _loc4_;
         this.var_1049 = getTimer();
         this.var_1588 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1587,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1388,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1498,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_168 || _loc13_ == RoomPlaneData.const_309)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
