package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_638:int = 500;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2495 = this._lastUpdateTime;
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2495;
            if(_loc2_ > this.var_1131)
            {
               _loc2_ = this.var_1131;
            }
            _loc3_ = Vector3d.product(this.var_1368,_loc2_ / Number(this.var_1131));
