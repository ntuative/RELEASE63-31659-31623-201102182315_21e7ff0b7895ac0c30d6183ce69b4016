package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_937:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_744 != _loc2_)
         {
            ...
            if(_loc3_ * const_418 > const_937)
            {
               this.var_1131 = const_937 / _loc3_;
            }
            else
            {
               this.var_1131 = const_418;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_744 && param1 >= this.var_1394 + this.var_1131)
            {
               ...
               this.var_1394 = param1 - (_loc3_ - _loc4_ * this.var_1131);
            }
         }
      }
   }
