   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2340 = param1.extra;
            this.var_1095 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1095 > 0 && param1 >= this.var_1095)
         {
            this.var_1095 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1664,String(this.var_1664),this.var_2340);
