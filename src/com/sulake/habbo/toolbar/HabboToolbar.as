package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1324:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1324 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_544,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1193,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1117,this.onHideWindowEvent);
         this._state = true;
