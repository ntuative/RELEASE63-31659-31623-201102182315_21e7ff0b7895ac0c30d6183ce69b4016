package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_143.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_145,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1665,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1665,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_125.removeEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
            this.var_125.removeEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
            this.var_125 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_125 = new SSOTicket(this.var_143.assets,_loc3_,_loc2_,param1);
         this.var_125.addEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
         this.var_125.addEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_143.shockwaveClientUrl = this.var_125.shockwaveClientUrl;
         this.var_143.ssoTicket = this.var_125.ticket;
         this.var_125.removeEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
         this.var_125.removeEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
         this.var_125 = null;
         dispatchEvent(new Event(const_521));
