package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2392:PseudoRandom;
      ...
      private var var_212:HabboHotelView;
      
      private var var_1341:String = "";
      
      private const const_1665:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_591 = param1;
            this.var_49.initConnection(HabboConnectionType.const_249);
         }
      }
      ...
      {
         if(this.var_49 && this.var_151 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_212 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_212.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_151.getKey("use.sso.ticket") == "1";
         this.var_591 = this.var_151.getKey("sso.ticket",null);
         this.var_1682 = this.var_151.getKey("flash.client.url","");
         this.var_2394 = this.var_151.getKey("external.variables.txt","");
         if(this.var_212 == null)
         {
            this.var_212 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_49.mode = HabboConnectionType.const_115;
            if(this.var_591)
            {
               this.var_49.initConnection(HabboConnectionType.const_249);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_49.mode = HabboConnectionType.const_1079;
            }
         }
         this.var_49.initConnection(HabboConnectionType.const_249);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_796);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2392 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_49.mode)
         {
            case HabboConnectionType.const_115:
               ...
               this.var_212.loadBannerImage(_loc7_ + "?token=" + this.var_1341,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1079:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1497:
               this.var_885 = this.generateRandomHexString(30);
               this.var_482 = new DiffieHellman(new BigInteger(this.var_151.getKey("connection.development.prime"),16),new BigInteger(this.var_151.getKey("connection.development.generator"),16));
               this.var_482.init(this.var_885);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2392);
         var _loc8_:ByteArray = CryptoTools.method_9(_loc5_);
         _loc8_.position = 0;
         _loc6_.init(_loc8_);
         _loc8_.position = 0;
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1682,this.var_2394));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1665,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_591 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_591);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2393)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1341);
