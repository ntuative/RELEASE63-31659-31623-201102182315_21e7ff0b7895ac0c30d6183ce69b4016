package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2503:uint = 2;
      
      private var var_2502:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1822 = param1.roomItemTypeName;
         this.var_1820 = param1.rewardCurrencyAmount;
         this.var_1754 = new Date();
         this.var_1754.setTime(param1.endDateTimeStamp);
         this.var_749 = param1.localizationCode;
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_64.code,this.var_749].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_200)
            {
               this.var_915.style = this.var_2502;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_200)
            {
               this.var_915.style = this.var_2503;
            }
         }
      }
