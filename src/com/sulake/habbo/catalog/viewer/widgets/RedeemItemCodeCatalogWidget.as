package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_875:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_876.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_876 = null;
         }
         if(this.var_875 != null)
         {
            this.var_875.removeEventListener(WindowKeyboardEvent.const_201,this.windowKeyEventProcessor);
            this.var_875 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_876 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_876 != null)
         {
            this.var_876.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_875 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_875 != null)
         {
            this.var_875.addEventListener(WindowKeyboardEvent.const_201,this.windowKeyEventProcessor);
         }
         return true;
      }
