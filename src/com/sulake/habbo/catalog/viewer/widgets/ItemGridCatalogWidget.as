package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_351:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_672,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_289,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_731,this.deActivateScrollbar);
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            ...
            {
               _loc4_ = page.offers[this.var_844];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_483)
         {
            ++this.var_1598;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1598);
         }
      }
