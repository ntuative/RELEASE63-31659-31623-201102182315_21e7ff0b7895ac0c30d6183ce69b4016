package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1150:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1792:XML;
      
      private var var_1791:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1150 = new PrizeViewer();
         this.var_733 = this.recycler.getPrizeTable();
         ...
         if(this.var_733.length > 0 && this.var_733[0].prizes.length > 0)
         {
            this.select(this.var_733[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_733.length)
         {
            this.createLevelItem(this.var_733[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1792) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1150.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
