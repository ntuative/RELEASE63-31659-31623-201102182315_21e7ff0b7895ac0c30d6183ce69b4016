package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1909:Point;
      
      private var var_519:IItemGridWindow;
      
      private var var_1466:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_972 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_1909 = new Point(this.var_86.x,this.var_86.y);
         this.var_519 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1466 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1908 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_972.text = _loc4_;
         this.var_1198.text = _loc5_;
         this.var_972.height = this.var_972.textHeight + 5;
         this.var_1198.y = this.var_972.y + this.var_972.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_483:
                  _loc6_ = this.var_1908.clone();
                  if(this.var_519 != null)
                  {
                     this.var_519.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_519,this.var_1466,this.var_1792);
                     ...
                     case ProductTypeEnum.const_214:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_324,AvatarAction.const_507);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2701)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2701 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1909.x;
            this.var_86.y = this.var_1909.y;
            if(param3 != null)
            {
