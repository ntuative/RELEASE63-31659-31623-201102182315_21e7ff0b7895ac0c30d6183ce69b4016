package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_223)
         {
            this.var_223 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_223)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_223.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_223.setGlobalPosition(_loc6_.subtract(new Point(this.var_223.width / 2,this.var_223.height / 2)));
         this.var_223.visible = true;
         this.var_223.activate();
      }
