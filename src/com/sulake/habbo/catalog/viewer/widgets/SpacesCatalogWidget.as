package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1576:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1470[this.var_430];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1469[this.var_432];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1471[this.var_433];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1576);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_980[this.var_430];
         for each(_loc1_ in this.var_184.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_431 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_431];
                  if(_loc9_ != null)
                  {
                     this.var_1577 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_432];
         ...
         _loc6_ = this.var_1469[this.var_432];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_979[this.var_433];
         for each(_loc1_ in this.var_184.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_523];
               if(_loc13_ != null)
               {
                  this.var_1576 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1471[this.var_433];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_209:
               ...
               if(this.var_430 < 0)
               {
                  this.var_430 = this.var_980.length - 1;
               }
               if(this.var_430 == this.var_980.length)
               {
                  this.var_430 = 0;
               }
               this.var_431 = 0;
               this.var_982 = 0;
               _loc5_ = this.var_980[this.var_430];
               for each(_loc8_ in this.var_184.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_982 = _loc8_.children().length();
                  }
               }
            ...
            case const_210:
               ...
               if(this.var_432 < 0)
               {
                  this.var_432 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_432 >= this._activeFloorPatterns.length)
               {
                  this.var_432 = 0;
               }
               this.var_522 = 0;
               this.var_981 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_432];
               for each(_loc9_ in this.var_184.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_981 = _loc9_.children().length();
                  }
               }
            ...
            case const_94:
               ...
               if(this.var_433 < 0)
               {
                  this.var_433 = this.var_979.length - 1;
               }
               if(this.var_433 >= this.var_979.length)
               {
                  this.var_433 = 0;
               }
               this.var_523 = 0;
               this.var_983 = 0;
               _loc7_ = this.var_979[this.var_433];
               for each(_loc10_ in this.var_184.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_983 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1577,this.var_1576,64,this,"window_romantic_wide");
         ...
         {
            this.var_1919 = _loc2_.id;
            this.var_1918 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_371 != null && this.var_372 != null)
         {
            this.setRoomImage(this.var_371,this.var_372);
         }
      }
   }
}
