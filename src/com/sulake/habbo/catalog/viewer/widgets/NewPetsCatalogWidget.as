package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1301:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_494 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_494 < 8)
         {
            return false;
         }
         this.var_2537 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_199 != null && this.var_199.length > 0)
         {
            this.var_350 = this.var_199[0];
         }
         else
         {
            this.var_350 = -1;
         }
         this._offers.add(this.var_494,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_199 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1301 && _loc2_ < this.var_199.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_494,this.var_199[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_199 != null && this.var_199.length > 0)
         {
            ...
            this.var_350 = this.var_199[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_494,this.var_350),this.getRaceLocalizationKey(this.var_494,this.var_350));
            }
         }
         return this.getRaceLocalizationKey(this.var_494,this.var_350);
      }
