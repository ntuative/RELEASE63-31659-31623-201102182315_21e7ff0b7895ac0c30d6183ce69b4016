package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected var var_1989:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1150:ICatalogViewer;
      ...
      private var var_514:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_514 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1186);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1186);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1989 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1989) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1516:
               if(this.var_1185 == null)
               {
                  this.var_1185 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1185);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1369:
               ...
               break;
            case CatalogWidgetEnum.const_1496:
            ...
            case CatalogWidgetEnum.const_1441:
               ...
               break;
            case CatalogWidgetEnum.const_1476:
            ...
            case CatalogWidgetEnum.const_1466:
               ...
               break;
            case CatalogWidgetEnum.const_1367:
            ...
            case CatalogWidgetEnum.const_1490:
               ...
               break;
            case CatalogWidgetEnum.const_1584:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_514.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_514 != null)
         {
            return this.var_514.dispatchEvent(param1);
         }
         return false;
      }
   }
