package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1863:IProductData;
      ...
      {
         super();
         this.var_1860 = param1.productType;
         this.var_1861 = param1.furniClassId;
         this.var_1439 = param1.extraParam;
         this.var_1438 = param1.productCount;
         this.var_1862 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_82:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1439);
               break;
