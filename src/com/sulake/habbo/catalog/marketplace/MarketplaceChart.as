package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_557)
            {
               this.var_557 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_557).toString().length - 1);
         this.var_557 = Math.ceil(this.var_557 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_557.toString();
         _loc3_.draw(_loc6_);
         this.var_1026 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(this.var_1026 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1026,(param2 - this.var_828) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1026 + this.var_1026 / -this.var_2752 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_828 - this.var_828 / this.var_557 * this.var_155[param1];
      }
