package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1334:String = "poster";
       
      
      public const const_1754:int = 1;
      
      public const const_1724:int = 2;
      ...
      private var var_2614:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_213)
         {
            this.var_213 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_213.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2616,this.var_2613,this.var_2617,this.var_2615);
      }
      ...
      {
         if(!this.var_180 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_180.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_573)
            {
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_180)
         {
            for each(_loc5_ in this.var_180)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_180.add(_loc4_.offerId,_loc6_);
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2556 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_180.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_180.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_180.add(parser.offerId,updateItem);
            }
            this.var_180.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1724,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2171 || param1.furniTypeId != this.var_2167)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1334)
               {
                  _loc2_ = true;
               }
            }
