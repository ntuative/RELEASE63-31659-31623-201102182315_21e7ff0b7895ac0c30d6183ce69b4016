package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_963:int = 0;
      ...
      {
         return this.var_644 != const_963;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1920 != RecyclerStatusMessageEvent.const_1085;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_644 == const_419;
      }
      ...
      {
         this.var_644 = const_964;
         this.var_119 = new Array(const_195);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1920)
         {
            case RecyclerStatusMessageEvent.const_1590:
               this.var_644 = const_419;
               if(this._view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_1085:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1574:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1118:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1604:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_119.length < const_195)
         {
            return false;
         }
         var _loc1_:int = 0;
