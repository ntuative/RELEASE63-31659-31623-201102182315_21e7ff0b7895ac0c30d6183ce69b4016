package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_288:CatalogViewer;
      ...
      private var var_289:ChargeConfirmationDialog;
      ...
      private var var_2396:GiftWrappingConfiguration;
      
      private var var_1105:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_213 == null)
            {
               this.var_213 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_213.showOffer(this,param1,param2,param3,_loc4_);
      ...
      {
         var _loc2_:Array = this.var_714.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_98.getActivityPointsForType(Purse.const_179)));
         var _loc1_:int = 0;
      ...
      {
         this.var_172.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.var_172 != null && _loc2_)
         {
            this.var_172.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_288.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_288 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_288.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1685 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1105 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_715 && this.var_715 != "")
         {
            this.var_345.openPage(this.var_715);
            this.var_715 = "";
            this.var_886 = -1;
         }
         else if(this.var_886 > -1)
         {
            this.var_345.openPageById(this.var_886,this.var_1686);
            this.var_886 = -1;
            this.var_1686 = -1;
            this.var_715 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_288.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_288.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2398 && this.var_592 != null)
         {
            this.var_592.playSound(HabboSoundTypesEnum.const_972);
         }
         this.var_2398 = false;
         if(this.var_289 != null)
         {
            this.var_289.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_66,this.var_98.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2397 && this.var_592 != null)
         {
            this.var_592.playSound(HabboSoundTypesEnum.const_1098);
         }
         this.var_2397 = false;
         if(this.var_289 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1105.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_288.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2396 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_289 == null)
         {
            this.var_289 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_289.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_714.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_714.add(_loc2_.productCode,_loc3_.slice());
            this.var_288.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
