package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1981:int = 10;
      ...
      private const const_1982:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_737 = _loc1_.boxTypes;
            this.var_736 = _loc1_.ribbonTypes;
            this.var_1152 = this.var_1490[0];
            this.var_353 = this.var_737[0];
            this.var_355 = this.var_736[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_355 < 0)
         {
            this.var_355 = this.var_736.length - 1;
         }
         if(this.var_355 > this.var_736.length - 1)
         {
            this.var_355 = 0;
         }
         if(this.var_353 < 0)
         {
            this.var_353 = this.var_737.length - 1;
         }
         if(this.var_353 > this.var_737.length - 1)
         {
            this.var_353 = 0;
         }
         var _loc1_:int = this.var_737[this.var_353] * 1000 + this.var_736[this.var_355];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1152,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1385 = _loc3_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1152);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_737[this.var_353]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_736[this.var_355]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1384,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1384);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               for each(_loc7_ in this.var_225)
               {
                  ...
                  if(_loc5_.length >= this.const_1981)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2554 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_370:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_255 == null || this.var_607 == null)
         {
            return;
         }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1152;
               }
            }
            _loc4_++;
         }
