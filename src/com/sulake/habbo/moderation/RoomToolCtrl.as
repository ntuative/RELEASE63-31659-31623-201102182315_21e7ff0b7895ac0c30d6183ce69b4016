package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1418:ICheckBoxWindow;
      ...
      public function populate() : void
      {
         ...
         this.var_1171 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1171);
         this.var_1171.procedure = this.onSelectTemplate;
         this.var_942 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1418 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_779,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_942.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1622,_loc2_,this.var_485.text,"",""));
         if(this.var_1418.isSelected || this.var_1417.isSelected || this.var_942.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1418.isSelected,this.var_1417.isSelected,this.var_942.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1363);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1171.selection];
         if(_loc3_ != null)
         {
            this.var_590 = false;
            this.var_485.text = _loc3_;
         }
      }
   }
}
