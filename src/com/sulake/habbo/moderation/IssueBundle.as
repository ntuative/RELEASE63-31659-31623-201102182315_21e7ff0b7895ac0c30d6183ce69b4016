package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_668:IssueMessageData = null;
      
      private var var_667:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2018 = param2.pickerUserId;
         this.var_2088 = param2.pickerUserName;
         this.var_1300 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_668 == null || param1.timeStamp < this.var_668.timeStamp)
         {
            this.var_668 = param1;
         }
         if(this.var_667 == null || param1.priority > this.var_667.timeStamp)
         {
            this.var_667 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_667;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_668;
         if(_loc2_ == null)
         {
