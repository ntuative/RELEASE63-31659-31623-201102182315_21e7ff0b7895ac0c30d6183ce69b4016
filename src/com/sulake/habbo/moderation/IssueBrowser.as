package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1998:String = "closed_issues";
      ...
      private var var_1762:IIssueBrowserView;
      
      private var var_1761:IIssueBrowserView;
      
      private var var_1760:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         var _loc1_:ISelectableWindow = this.var_250.selector.method_1("open_issues");
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_348.view.width = this.var_250.container.width;
         this.var_348.view.height = this.var_250.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1964:
               ...
               {
                  this.var_1762 = new MyIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1762;
            case this.const_1966:
               if(this.var_1761 == null)
               {
                  this.var_1761 = new OpenIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1761;
            case this.const_1965:
               if(this.var_1760 == null)
               {
                  this.var_1760 = new PickedIssuesView(this.issueManager,this,this.var_250.container);
               }
