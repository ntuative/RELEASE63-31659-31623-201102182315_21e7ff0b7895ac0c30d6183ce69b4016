package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1689:int = 1000;
      
      private static var var_887:Array = [];
      
      private static var var_1688:int = 200;
      ...
      private var var_1690:IMessageComposer;
      ...
      public function show() : void
      {
         ...
         this.var_717 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1690);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_717.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_888.length < var_1689)
         {
            ...
            param1.width = this.var_717.width;
            param1.height = this.var_717.height;
            var_888.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_887.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1687[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
