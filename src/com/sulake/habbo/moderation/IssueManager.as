package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_708:String = "issue_bundle_my";
      
      public static const const_1069:String = "issue_bundle_picked";
      
      public static const const_1370:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_2543 = parseInt(this.var_63.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1786 = new Timer(const_1370,0);
         this.var_1786.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1786.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1149 = this.var_1149.concat(_loc4_.getIssueIds());
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_63.soundManager.playSound(HabboSoundTypesEnum.const_974);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1588)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_708);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2543);
            }
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_366 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
