package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1075 + param1.height > this.var_1076.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1075 += param1.height + this.const_1954;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1075);
         this._offsetX += param1.width + this.const_1953;
         return true;
      }
