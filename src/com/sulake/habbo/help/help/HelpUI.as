package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102182309));
         this.var_172 = param5;
         this.var_115 = new Map();
         this.var_115.add(HabboHelpViewEnum.const_1569,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_115.add(HabboHelpViewEnum.const_450,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_290,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_246,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_115.add(HabboHelpViewEnum.const_719,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_115.add(HabboHelpViewEnum.const_1086,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_115.add(HabboHelpViewEnum.const_1186,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_628,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_504.length == 0 || param1 != this.var_358)
            {
               this.var_504.push(this.var_358);
            }
         }
         this.var_358 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_172.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_226:
               ...
               break;
            case CallForHelpResultEnum.const_1007:
               this.showUI(HabboHelpViewEnum.const_1186);
               break;
            case CallForHelpResultEnum.const_1122:
               this.showUI(HabboHelpViewEnum.const_1086);
         }
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_498));
      }
      ...
      {
         return this.var_115.getValue(this.var_358);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2083 = this._window.width - _loc4_.width;
         this.var_2082 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2082;
         this._window.width = _loc1_.width + this.var_2083;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_200)
         {
            return;
         }
         if(this.var_611.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_611.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_611[1],this.var_611[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_611[0],this.var_611[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_200 || this.var_504.length == 0)
         {
            return;
         }
         if(this.var_357 == null)
