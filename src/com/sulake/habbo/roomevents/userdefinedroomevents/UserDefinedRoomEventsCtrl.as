package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1784:TriggerConfs;
      
      private var var_1783:ActionTypes;
      
      private var var_1785:ConditionTypes;
      
      private var var_253:Dictionary;
      
      private var var_61:Triggerable;
      
      private var var_731:RoomObjectHightLighter;
      
      private var var_170:UserDefinedRoomEventsHelp;
      
      private var var_1146:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1784 = new TriggerConfs();
         this.var_1783 = new ActionTypes();
         this.var_1785 = new ConditionTypes();
         this.var_253 = new Dictionary();
         super();
         this.var_91 = param1;
         this.var_731 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_253[param1])
         {
            ...
            this.var_731.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_61.furniLimit)
         {
            this.var_253[param1] = param2;
            this.var_731.show(param1);
         }
         this.refresh();
      }
      ...
      {
         return this.resolveHolder().getElementByCode(this.var_61.code);
      }
      
      private function resolveHolder() : ElementTypeHolder
      {
         if(this.var_61 as TriggerDefinition != null)
         {
            return this.var_1784;
         }
         if(this.var_61 as ActionDefinition != null)
         {
            return this.var_1783;
         }
         if(this.var_61 as ConditionDefinition != null)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_91.getXmlWindow("ude_main"));
         this.var_92 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_92,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_92,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_92,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_92,"apply_snapshot_txt"),this.onApplySnapshot);
         this.find(this.var_92,"helplink").mouseThreshold = 0;
         this.find(this.var_92,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1146 = new SliderWindowController(this.var_91,IWindowContainer(this.find(this.var_92,"delay_slider_container")),this.var_91.assets,0,20,1);
         this.var_1146.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1146.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_91.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_91.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_731.hideAll(this.var_253);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.prepareWindow();
         this.var_61 = param1;
         Logger.log("Received: " + this.var_61 + ", " + param1.code);
         var _loc2_:Element = this.resolveType();
         this.var_731.hideAll(this.var_253);
         this.var_253 = new Dictionary();
         for each(_loc3_ in this.var_61.stuffIds)
         {
            this.var_253[_loc3_] = "yes";
         }
         _loc4_ = !!_loc2_.hasSpecialInputs ? this.prepareCustomInput() : null;
         _loc2_.onEditStart(_loc4_,this.var_61);
         this.var_731.showAll(this.var_253);
         if(this.var_61 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_61);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1146.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_61 as TriggerDefinition != null)
         {
            this.var_91.send(new UpdateTriggerMessageComposer(this.var_61.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_61 as ActionDefinition != null)
         {
            this.var_91.send(new UpdateActionMessageComposer(this.var_61.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_61 as ConditionDefinition != null)
         {
            this.var_91.send(new UpdateConditionMessageComposer(this.var_61.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1146.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.send(new ApplySnapshotMessageComposer(this.var_61.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1785);
      ...
      {
         if(!param1.acceptTriggerable(this.var_61))
         {
            this.find(this.var_92,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_92,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_92,3,5);
         this.var_92.height = Util.getLowestPoint(this.var_92) + 1;
      }
      
      private function getElementName(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_91.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_92,"header_container"));
         this.find(_loc3_,param2 + "_icon_bitmap").visible = true;
         this.setText(_loc3_,"conf_name_txt",this.getElementName(this.var_61.stuffTypeId));
         this.setText(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_61.stuffTypeId));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_92,"action_inputs_container"));
         if(this.var_61 as ActionDefinition == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         var _loc1_:ActionDefinition = ActionDefinition(this.var_61);
         ...
         this.var_91.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_91.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_91.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         var _loc1_:TriggerDefinition = TriggerDefinition(this.var_61);
         ...
         this.var_91.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_91.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_91.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      
      private function refreshWarning(param1:String, param2:String) : void
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_92,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_92,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_92.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_92.findChildByName("custom_inputs_container"));
         var _loc4_:String = _loc1_.getKey() + _loc2_.code;
         var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_91.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_91);
         }
         return _loc5_;
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_92.findChildByName("select_furni_container"));
         if(!this.isStuffSelectionMode())
         {
            _loc1_.visible = false;
            return;
         ...
         var _loc4_:int = this.var_61.furniLimit;
         this.var_91.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_91.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
   }
}
