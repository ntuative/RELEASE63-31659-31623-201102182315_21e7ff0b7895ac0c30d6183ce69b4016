package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      {
         return int(this.var_1511 * (Number(param1 - this._minValue) / (this.var_1172 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1511 * (this.var_1172 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_946)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_178)
            {
               this.var_946 = false;
            }
         }
         if(!this.var_946 || param1.type != WindowEvent.const_396)
         {
            return;
         }
         if(this.var_620 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_620) * this.var_620;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_620 != 0)
            {
               _loc3_ = this.var_947 + this.var_620;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_660 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_660.width,this.var_660.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_660,this.var_660.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_661 != null)
            {
               ...
               this.var_1511 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_660 = BitmapData(_loc2_.content);
