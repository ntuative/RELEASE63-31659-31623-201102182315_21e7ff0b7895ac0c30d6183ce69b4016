package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1087:BitmapData = null;
      
      private var var_1086:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2327 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2329 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2328 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1653 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1088 == 0)
         {
            this.var_1088 = getTimer();
            return false;
         }
         if(this.var_1653 > 0 && this.var_1652 >= this.var_1653)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1088;
         if(_loc1_ > this.var_2329)
         {
            ++this.var_1652;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1326 = _loc2_.imageUrl;
         this.var_2330 = _loc2_.clickUrl;
         this.var_1088 = getTimer();
         if(this.var_1326 != "")
         {
            _loc3_ = this.var_1326;
            ...
            {
               this.var_210 = new Timer(this.var_2328,1);
            ...
            this.var_210.start();
            _loc4_ = new URLRequest(this.var_1326);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_466,0,0,param1.bitmapData,this.var_2330));
            this.var_1088 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_427));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1325 = _loc2_.imageUrl;
         this.var_1654 = _loc2_.clickUrl;
         if(this.var_1325 != "" && this.var_1654 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1325);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_425,0,0,_loc4_,this.var_1654,this.var_1087,this.var_1086));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1087 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1086 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
