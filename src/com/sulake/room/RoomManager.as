package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_737:int = -1;
      ...
      private var var_2812:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_852,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_615 == null || this.var_506 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_613.indexOf(_loc5_) < 0)
            {
               this.var_51.loadObjectContent(_loc5_,events);
               this.var_613.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_51 == null || this.var_506 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_116.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_116.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_116.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_506.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_506.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
