package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1104:Number = 32;
      ...
      private var var_2785:Number = -500.0;
      
      private var var_2784:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1187 = new Vector3d();
         this.var_1877 = 1;
         this.var_1879 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1878 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_79.x * this.var_422,this.var_79.y * this.var_423,this.var_79.z * this.var_421);
      }
      ...
      {
         if(this.var_422 != param1 * this.var_1877)
         {
            this.var_422 = param1 * this.var_1877;
            ++this.var_163;
         }
      }
      ...
      {
         if(this.var_423 != param1 * this.var_1879)
         {
            this.var_423 = param1 * this.var_1879;
            ++this.var_163;
         }
      }
      ...
      {
         if(this.var_421 != param1 * this.var_1878)
         {
            this.var_421 = param1 * this.var_1878;
            ++this.var_163;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_79.x;
         var _loc3_:Number = this.var_79.y;
         var _loc4_:Number = this.var_79.z;
         this.var_79.assign(param1);
         this.var_79.x /= this.var_422;
         this.var_79.y /= this.var_423;
         this.var_79.z /= this.var_421;
         if(this.var_79.x != _loc2_ || this.var_79.y != _loc3_ || this.var_79.z != _loc4_)
         {
            ++this.var_163;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_515 != null)
         {
            ...
            this.var_515.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_515.add(_loc3_,_loc4_);
            ++this.var_163;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_515 != null)
         {
            ...
            return this.var_515.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1187.assign(_loc22_);
         }
         else
         {
            this.var_1187.assign(_loc17_);
         }
         ++this.var_163;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_79);
         _loc2_.x *= this.var_422;
         _loc2_.y *= this.var_423;
         _loc2_.z *= this.var_421;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1187);
         if(_loc3_ < this.var_2785 || _loc3_ > this.var_2784)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_79);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_422;
            _loc2_.y *= this.var_423;
            _loc2_.z *= this.var_421;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1187);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_79.x * this.var_422,this.var_79.y * this.var_423,this.var_79.z * this.var_421);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_156;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_422,param2.y * this.var_423,param2.z * this.var_421);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_422,param3.y * this.var_423,param3.z * this.var_421);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_422,param4.y * this.var_423,param4.z * this.var_421);
