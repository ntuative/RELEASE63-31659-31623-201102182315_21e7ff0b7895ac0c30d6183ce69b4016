package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1355:int = 128;
      
      private var var_1356:Boolean = false;
      
      private var var_2764:Point;
      ...
      {
         if(param1 != this.var_1720 || param2 != this.var_1719)
         {
      ...
      {
         if(this.var_1355 > 255 || bitmapData == null)
         {
            return false;
         }
