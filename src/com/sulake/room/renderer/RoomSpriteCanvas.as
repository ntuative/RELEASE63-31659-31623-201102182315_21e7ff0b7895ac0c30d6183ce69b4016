package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1670:int = 50;
      ...
      private var var_561:RoomObjectCache;
      
      private var var_464:Array;
      
      private var var_565:Array;
      
      private var var_1286:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2183:Number = -1.0E7;
      
      private var var_2182:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_236.addChild(this.var_56);
         ...
         this.var_561 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_465.x -= param1 - this.var_563;
         this.var_563 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_465.y -= param1 - this.var_562;
         this.var_562 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_843 = true;
            if(this.var_126 != null && !this.var_236.contains(this.var_126))
            {
               this.var_236.addChild(this.var_126);
               this.var_56.mask = this.var_126;
            }
         }
         else if(!param1 && this.var_843)
         {
            this.var_843 = false;
            if(this.var_126 != null && this.var_236.contains(this.var_126))
            {
               this.var_236.removeChild(this.var_126);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_565.length)
            {
               this.cleanSprite(this.var_565[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_565 = [];
         }
      ...
      {
         this.var_561.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_680 != this.var_2181 || this._ht != this.var_2185)
         {
            _loc9_ = true;
         }
         if(this.var_56.x != this.var_563 || this.var_56.y != this.var_562)
         {
            this.var_56.x = this.var_563;
            this.var_56.y = this.var_562;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_464.sortOn("z",0 | 0);
         if(_loc5_ < this.var_464.length)
         {
            this.var_464.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_464[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2181 = this.var_680;
         this.var_2185 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_561.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_561.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_563;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_562;
                  if(_loc19_ < this.var_680 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_464.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_563;
                     _loc17_.y = _loc20_ - this.var_562;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_565.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_681 || this.var_681 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_464.length)
         {
            return null;
         }
         return this.var_464[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1047 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1580;
         }
         this.var_1580 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1047;
         return this.var_1580;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_680 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1579,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_564.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_564.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2183 || param2 != this.var_2182)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_564.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_564.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_328.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1286.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
